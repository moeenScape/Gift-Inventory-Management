...
public interface SampleSectionController {
    ...
    ResponseEntity<?> createSSu(@RequestBody SsuDto sampleSectionUnit, BindingResult bindingResult);
    ...
    ResponseEntity<?> updateSSU(@RequestBody SampleSectionUnit sampleSectionUnit, @PathVariable Long ssuID);
